...
| [0017](0017-diff-driven-impact.md) | Diff-driven impact (`atlas impact --diff`) | Accepted |
| [0018](0018-interactive-html-map.md) | Interactive HTML map (`atlas viz`) | Accepted |
